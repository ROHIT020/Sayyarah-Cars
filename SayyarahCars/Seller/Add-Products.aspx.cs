...
namespace SayyarahCars.Seller
{
    public partial class Add_Products : System.Web.UI.Page
    {
        ...
        protected void bindPurchase()
        {
            ...
            DataSet ds = _clsA.SelectSellerProductsById(id);
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                bindvariant();
                ddlModel.SelectedValue = ds.Tables[0].Rows[0]["variantid"].ToString();
                txtChassisNo.Text = ds.Tables[0].Rows[0]["ChassisNo"].ToString();
                if (ds.Tables[0].Rows[0]["MDate"].ToString() != string.Empty)
                {
                    txtMDate.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["MDate"]).ToString("yyyy-MM-dd");
                }
                if (ds.Tables[0].Rows[0]["RDate"].ToString() != string.Empty)
                {
                    txtRDate.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["RDate"]).ToString("yyyy-MM-dd");
                }
                ...
                ddlSellerType.SelectedValue = ds.Tables[0].Rows[0]["SellerType"].ToString();
                ...
                ddlSeller.SelectedValue = ds.Tables[0].Rows[0]["SID"].ToString();
                if (ds.Tables[0].Rows[0]["SellerType"].ToString() == "3")
                {
                    if (ds.Tables[0].Rows[0]["ADate"].ToString() != string.Empty)
                    {
                        txtAuctionDate.Text = Convert.ToDateTime(ds.Tables[0].Rows[0]["ADate"]).ToString("yyyy-MM-dd");
                    }
                    ddlAuctionSource.SelectedValue = ds.Tables[0].Rows[0]["SAID"].ToString();
                }
                ddlptype1.SelectedValue = ds.Tables[0].Rows[0]["ptype1"].ToString();
                ddlptype2.SelectedValue = ds.Tables[0].Rows[0]["ptype2"].ToString();
                bindImages();
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            try
            {
             ...
             //   _obj.SellerType = ddlSellerType.SelectedValue;
             //   _obj.SID = ddlSeller.SelectedValue;
                if (ddlSellerType.SelectedValue == "3")
                {
                    _obj.ADate = txtAuctionDate.Text.Trim();
                    _obj.SAID = ddlAuctionSource.SelectedValue;
                }
            //    _obj.ptype1 = ddlptype1.SelectedValue;
            //    _obj.ptype2 = ddlptype2.SelectedValue;
                _obj.uid = uid;
                if (btnsubmit.Text != "Update")
                {
                    int rtval = _clsA.insertSellerProducts(_obj);
                    if (rtval != 0)
                    {
                        CommonFunction.MessageBox(this, "S", "Record saved Successfully!!");
                        hdnid.Value = cmf.Encrypt(rtval.ToString());
                        // Inject JavaScript to for show success message
                        string script = $@"
                        <script type='text/javascript'>
                            setTimeout(function() {{window.location.href = 'Seller-Products?id={hdnid.Value}';
                            }}, 2500);
                        </script>";
                ...
                else
                {
                    ...
                    int rtval = _clsA.updateSellerProducts(_obj);
                }
                //Response.Redirect("Seller-Products?id=" + hdnid.Value);
            }
            catch (Exception ex)
            {
        ...
        {
            string id = cmf.Decrypt(hdnid.Value);
            DataSet ds = _clsA.SelectSellerAdditionalInfo(id, "Image");
        ...
        protected void btnupload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (str != string.Empty)
                {
                    ...
                    _obj.uid = uid;
                    _obj.mtype = "ImageUrl";
                    _clsA.insertSellerProductsAdditionalInfo(_obj);
                    bindImages();
        ...
        {
            string id = cmf.Decrypt(hdnid.Value);
            DataSet ds = _clsA.SelectSellerAdditionalInfo(id, "Feature");
            if (ds.Tables[0].Rows.Count > 0)
            {
        ...
        {
            string id = cmf.Decrypt(hdnid.Value);
            DataSet ds = _clsA.SelectSellerAdditionalInfo(id, "Left");
        ...
        {
            string id = cmf.Decrypt(hdnid.Value);
            DataSet ds = _clsA.SelectSellerAdditionalInfo(id, "Right");
        ...
        {
            string id = cmf.Decrypt(hdnid.Value);
            DataSet ds = _clsA.SelectSellerAdditionalInfo(id, "Front");
        ...
        {
            string id = cmf.Decrypt(hdnid.Value);
            DataSet ds = _clsA.SelectSellerAdditionalInfo(id, "Rear");
        ...
        {
            string id = cmf.Decrypt(hdnid.Value);
            DataSet ds = _clsA.SelectSellerAdditionalInfo(id, "Document");
