<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Seller.Master" AutoEventWireup="true" CodeBehind="MyProducts.aspx.cs" Inherits="SayyarahCars.Seller.MyProducts" %>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-secondary" href="Add-Products.aspx" title="Seller Products"><i class="ti ti-circle-plus-filled"></i>Add Products</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtYearF" runat="server" TextMode="Date" autocomplete="off" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="form-group">
                                <label class="form-label">Year To</label>
                                <asp:TextBox ID="txtYearT" runat="server" TextMode="Date" autocomplete="off" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped align-middle"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Action">
                                <ItemTemplate>
                                    <div class="text-end">
                                        <a class="avtar edit" href="Add-Products.aspx?id=<%#cmf.Encrypt(Eval("Id").ToString()) %>" title="my title"><i class="ti ti-pencil"></i></a>
