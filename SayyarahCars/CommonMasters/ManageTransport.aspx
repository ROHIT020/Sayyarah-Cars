<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="ManageTransport.aspx.cs" Inherits="SayyarahCars.CommonMasters.ManageTransport" %>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h5>Master Transport</h5>
                    <a class="btn btn-secondary" href="javascript:void(0);" title="my title" onclick="openCSSPopup('AddTransport.aspx','Add Transport','50vw','80vh')"><i class="ti ti-circle-plus-filled"></i>Add Transport</a>
                </div>
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped align-middle"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <div class="text-end">
                                           <a class="avtar edit" href="javascript:void(0);" title="my title" onclick="openCSSPopup('AddTransport.aspx?id=<%#cmf.Encrypt(Eval("ID").ToString()) %>','Edit Transport','50vw','80vh')"><i class="ti ti-pencil"></i></a>
