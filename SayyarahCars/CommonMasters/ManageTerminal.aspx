<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="ManageTerminal.aspx.cs" Inherits="SayyarahCars.CommonMasters.ManageTerminal" %>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="form-group mb-0">
                                <label class="form-label" for="shipping">Select Port Name</label>
                                <asp:DropDownList ID="ddlPort" runat="server" CssClass="chosen-select form-control"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-6 col-12">
                            <asp:Button ID="btnFilter" runat="server" Text="Search" CssClass="btn btn-primary mt-4" OnClick="btnFilter_Click" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h5>Terminal Master</h5>
                    <a class="btn btn-secondary" href="javascript:void(0);" title="my title" onclick="openCSSPopup('AddTerminal.aspx','Add Terminal Master')"><i class="ti ti-circle-plus-filled"></i>Add Terminal</a>
                </div>              
                <div class="card-body">
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped align-middle"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Terminal Address">
                                    <ItemTemplate>
                                        <%# Eval("Taddress") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <div class="text-end">
                                            <a class="avtar edit" href="javascript:void(0);" title="my title" onclick="openCSSPopup('AddTerminal.aspx?id=<%#cmf.Encrypt(Eval("ID").ToString()) %>','Edit Terminal Master')"><i class="ti ti-pencil"></i></a>
