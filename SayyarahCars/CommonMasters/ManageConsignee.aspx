<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="ManageConsignee.aspx.cs" Inherits="SayyarahCars.CommonMasters.ManageConsignee" %>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="form-group mb-0">
                                    ...
                                    <asp:DropDownList ID="ddlClient" runat="server" CssClass="chosen-select form-control"></asp:DropDownList>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h5>Consignee Master</h5>
                    <a class="btn btn-secondary" href="javascript:void(0);" title="my title" onclick="openCSSPopup('AddConsignee.aspx','Add Consignee Master','50vw','90vh')"><i class="ti ti-circle-plus-filled"></i>Add Consignee</a>
                </div>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped align-middle"
                            AutoGenerateColumns="False" PageSize="10" EmptyDataText="No Record Added." OnRowCommand="GridView1_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <div class="text-end">
                                            <a class="avtar edit" href="javascript:void(0);" title="my title" onclick="openCSSPopup('AddConsignee.aspx?id=<%#cmf.Encrypt(Eval("ID").ToString()) %>','Edit Consignee Master','50vw','90vh')"><i class="ti ti-pencil"></i></a>
