...
{
    public partial class ManageConsignee : System.Web.UI.Page
    {
        ...
        private void BindGrid(int pageNo = 1)
        {
            try
            {
                ...
                DataSet ds = cls.SelectConsignee();
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataSet ds = cls.SelectConsigneeClientById(clientId);
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    GridView1.DataSource = ds;
                    GridView1.DataBind();
