<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="ManageAuction.aspx.cs" Inherits="SayyarahCars.CommonMasters.ManageAuction" %>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h5>Auction Master</h5>
                    <a class="btn btn-secondary" href="javascript:void(0);" title="my title" onclick="openCSSPopup('AddAuction.aspx','Add Auction Master','50vw','90vh')"><i class="ti ti-circle-plus-filled"></i>Add Auction</a>
                </div> <div class="card-header justify-content-end">
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped align-middle"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <div class="text-end">
                                            <a class="avtar edit" href="javascript:void(0);" title="my title" onclick="openCSSPopup('AddAuction.aspx?id=<%#cmf.Encrypt(Eval("ID").ToString()) %>','Edit Auction','50vw','90vh')"><i class="ti ti-pencil"></i></a>
