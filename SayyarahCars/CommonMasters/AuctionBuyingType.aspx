<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="AuctionBuyingType.aspx.cs" Inherits="SayyarahCars.CommonMasters.AuctionBuyingType" %>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h5>Auction Buying Type</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="form-group row">
                                <label class="control-label"><b>Buying Name</b></label>
                                <div class="col-sm-6">
                                    <asp:TextBox
                                        ID="txtbuyingName"
                                        runat="server"
                                        CssClass="validate form-control"
                                        autocomplete="off"
                                        data-required="true"
                                        data-type="text"
                                        data-error-id="txtbuyingNameError"
                                        ClientIDMode="Static"
                                        Placeholder="Enter Buying Name"></asp:TextBox>
                                    <p id="txtbuyingNameError" class="error-message">Please enter Buying Name</p>
                                </div>
                                <div class="col-sm-3">
                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary btn-sm"
                            ...
                            <asp:GridView
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <div class="text-end">
                                                <asp:LinkButton ID="lnkEdit" runat="server" CommandName="EditRow" CssClass="avtar edit"
                                                    data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit"
                                                    CommandArgument='<%# Eval("ID") %>'><i class="ti ti-pencil"></i></asp:LinkButton>
