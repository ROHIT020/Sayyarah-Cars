<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="Document-Auction-Kanri.aspx.cs" Inherits="SayyarahCars.Admin.Document_Auction_Kanri" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-12">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlCountry" runat="server" CssClass="validate chosen-select form-control" ClientIDMode="Static"></asp:DropDownList>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12" style="overflow-x: auto; white-space: nowrap;">
                        <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped align-middle" OnPageIndexChanging="GridView1_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="AuctionRemark">
                                    <ItemTemplate>
                                        <%# Eval("AuctionRemark") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Noplate">
                                    <ItemTemplate>
                                        <%# Eval("Noplate") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Noplatestatus">
                                    <ItemTemplate>
                                        <%# Eval("Noplatestatus") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="DIN-date">
                                    <ItemTemplate>
                                        <%# Eval("Doc In date") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
