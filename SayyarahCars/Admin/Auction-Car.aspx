<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="Auction-Car.aspx.cs" Inherits="SayyarahCars.Admin.Auction_Car" %>
        ...
        <div id="Divserver" runat="server">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-striped align-middle" OnPageIndexChanging="GridView1_PageIndexChanging"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Auction Date">
                                <ItemTemplate>
                                    <uc:DateSelector ID="txtAuctionDate" runat="server" Text='<%# Eval("ADate") %>' CssClass="Validate form-control" DataType="calendar" />
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <div class="row">
                <div class="col-md-3" style="margin-top: 25px">
                    <asp:Button ID="btnUpdate" runat="server" Text="Update Auction" CssClass="btn btn-primary" OnClick="btnUpdate_Click" />
                </div>
            </div>
        </div>
    </div>
