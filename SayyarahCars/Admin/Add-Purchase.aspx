<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="Add-Purchase.aspx.cs" Inherits="SayyarahCars.Admin.Add_Purchase" %>
        ...
        <div class="col-lg-12 col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h5>Add Purchase</h5>
                    <a href="Manage-Purchase.aspx" class="btn btn-secondary"><i class="ti ti-eye"></i>View Purchase</a>
                </div>
                <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <uc:DateSelector ID="txtMDate" runat="server" CssClass="validate form-control" DataErrorId="errMDate" DataRequired="true" DataType="calendar" />
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <uc:DateSelector ID="txtRDate" runat="server" CssClass="validate form-control" DataErrorId="errRDate" DataRequired="true" DataType="calendar" />
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12" id="divAuctionDate" runat="server" visible="false">
                                        <div class="form-group">
                                            ...
                                            <uc:DateSelector ID="txtAuctionDate" runat="server" CssClass="validate form-control" DataErrorId="errADate" DataRequired="true" DataType="calendar" />
                                    ...
                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="form-label" for="product">Lot Number</label>
                                            <asp:TextBox ID="txtLotNo" runat="server" autocomplete="off" CssClass="validate form-control" data-required="true" data-type="text" data-error-id="errLotNo" placeholder="Enter Lot Number" ClientIDMode="Static"></asp:TextBox>
                                            <p id="errLotNo" class="error-message">Please enter Lot Number</p>
                                        </div>
                                    </div>

                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="form-label" for="product">Grade</label>
                                            <asp:TextBox ID="txtGrade" runat="server" autocomplete="off" CssClass="validate form-control" data-required="true" data-type="text" data-error-id="errGrade" placeholder="Enter Grade" ClientIDMode="Static"></asp:TextBox>
                                            <p id="errGrade" class="error-message">Please enter Grade</p>
                                        </div>
                                    </div>

                                    <div class="col-lg-3 col-md-6 col-12">
                                        <div class="form-group">
                                            <label class="form-label" for="product">Urgent</label>
                                ...
                                <div class="upload-block">
                                    <div class="upload-box" id="uploadBox" runat="server" clientidmode="Static">
                                        <div class="upload-content">
                                            ...
                                            <asp:FileUpload ID="flpupload" runat="server" multiple="multiple" Style="display: none" ClientIDMode="Static" onchange="triggerUpload()" />
                                            ...
                                            <div class="upload-block">
                                                <div class="upload-box" id="uploadBox_Left" runat="server" clientidmode="Static">
                                                    <div class="upload-content">
                                                        ...
                                                        <p class="upload-subtitle">Strictly PNG, JPG and JPEG files only.</p>
                                                        <button class="upload-button" type="button">Choose File</button>
                                                        <asp:FileUpload ID="flpupload_Left" multiple="multiple" runat="server" Style="display: none" onchange="triggerUpload_Left()" />
                                            ...
                                            <div class="upload-block">
                                                <div class="upload-box" id="uploadBox_Right" runat="server" clientidmode="Static">
                                                    <div class="upload-content">
                                                        ...
                                                        <p class="upload-subtitle">Strictly PNG, JPG and JPEG files only.</p>
                                                        <button class="upload-button" type="button">Choose File</button>
                                                        <asp:FileUpload ID="flpupload_Right" runat="server" multiple="multiple" Style="display: none" onchange="triggerUpload_Right()" />
                                            ...
                                            <div class="upload-block">
                                                <div class="upload-box" id="uploadBox_Front" runat="server" clientidmode="Static">
                                                    <div class="upload-content">
                                                        ...
                                                        <p class="upload-subtitle">Strictly PNG, JPG and JPEG files only.</p>
                                                        <button class="upload-button" type="button">Choose File</button>
                                                        <asp:FileUpload ID="flpupload_Front" runat="server" multiple="multiple" Style="display: none" onchange="triggerUpload_Front()" />
                                            ...
                                            <div class="upload-block">
                                                <div class="upload-box" id="uploadBox_Rear" runat="server" clientidmode="Static">
                                                    <div class="upload-content">
                                                        ...
                                                        <p class="upload-subtitle">Strictly PNG, JPG and JPEG files only.</p>
                                                        <button class="upload-button" type="button">Choose File</button>
                                                        <asp:FileUpload ID="flpupload_Rear" runat="server" multiple="multiple" Style="display: none" onchange="triggerUpload_Rear()" />
