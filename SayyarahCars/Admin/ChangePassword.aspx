<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="SayyarahCars.Admin.ChangePassword" %>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtnewpassword" runat="server" CssClass="form-control" placeholder="New Password" TextMode="Password" MaxLength="20" AutoCompleteType="None"></asp:TextBox>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtconfrimpwd" runat="server" TextMode="Password" CssClass="form-control" placeholder="New Password" MaxLength="20" AutoCompleteType="None"></asp:TextBox>
