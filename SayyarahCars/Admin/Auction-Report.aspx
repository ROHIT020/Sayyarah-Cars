<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="Auction-Report.aspx.cs" Inherits="SayyarahCars.Admin.Auction_Report" %>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-3 col-12">
                                    <div class="form-group">
                                        <label class="form-label">Auction Group</label>
                                        <asp:DropDownList ID="ddlAuctionG" runat="server" CssClass="validate chosen-select form-control" AutoPostBack="true" AppendDataBoundItems="true" OnSelectedIndexChanged="ddlAuctionG_SelectedIndexChanged" data-required="true" data-type="dropdown" ClientIDMode="Static"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-12">
                                    <div class="form-group">
