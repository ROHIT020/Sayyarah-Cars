...
{
    public partial class Shipping_History : System.Web.UI.Page
    {
        ...
        {
            ds = cls.GetDropDownShippingHistory();

            cmf.BindDropDownList(ddlShipping, ds, "ShippingName", "Id");
            ddlShipping.Items.Insert(0, new ListItem("Select Shipping", "0"));
        }

        public void BindAllData()
        {
            ShippingHistory obj = new ShippingHistory();
            ...
            ds = cls.GetAllShippingHistory(obj);
