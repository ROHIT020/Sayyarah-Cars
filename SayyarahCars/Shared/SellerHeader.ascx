<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SellerHeader.ascx.cs" Inherits="SayyarahCars.Shared.SellerHeader" %>
<header class="header">
        ...
        <ul class="user-menu">
            ...
            <li class="dropdown topbar-item">
                ...
                <div class="dropdown-menu dropdown-menu-end py-0" style="">
                    ...
                    <a class="dropdown-item" href="../Seller/MyProfile.aspx"><i class="las la-user fs-18 me-1 align-text-bottom"></i>Profile</a>
                    <a class="dropdown-item" href="../Seller/ChangePassword.aspx"><i class="las la-wallet fs-18 me-1 align-text-bottom"></i>Change Password</a>
