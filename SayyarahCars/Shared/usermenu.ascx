<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="usermenu.ascx.cs" Inherits="SayyarahCars.Shared.usermenu" %>
...
<script>
    $(window).bind("load", function () {
        ...
        $.ajax({
            type: "POST",
            url: "/WebServices/jquerydata.asmx/bindUserMenu",
            data: "{'UTYPE': '" + UTYPE + "'}",
            ...
            success: function (data) {
                ...
                tHtml += '<li>';
                tHtml += '<a href="/Users/Dashboard.aspx" class="active"><i class="ti ti-arrow-big-right"></i>Dashboard</a>';
                tHtml += '</li>';
...
<div class="toc">
    <div class="toc__inner">
        <div class="toc__logo">
            <a href="/">
                <img src="/Contents/admin/images/logo.png" class="logo" alt="Bizupon"></a>
        </div>
        <div class="toc__nav">
            <div class="sidebar">
