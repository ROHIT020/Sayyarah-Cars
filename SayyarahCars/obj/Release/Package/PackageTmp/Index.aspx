                ...
                <div class="right-box">
                    <div class="container position-relative">
                        ...
                        <div class="list-box" data-animation-in="fadeInUp" data-delay-in="0.3">
                            <div class="items">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="52"  height="52"  viewBox="0 0 24 24"  fill="none"  stroke="#fff"  stroke-width="1.2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-gas-station"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M14 11h1a2 2 0 0 1 2 2v3a1.5 1.5 0 0 0 3 0v-7l-3 -3" /><path d="M4 20v-14a2 2 0 0 1 2 -2h6a2 2 0 0 1 2 2v14" /><path d="M3 20l12 0" /><path d="M18 7v1a1 1 0 0 0 1 1h1" /><path d="M4 11l10 0" /></svg>
                            ...
                            <div class="items">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="52"  height="52"  viewBox="0 0 24 24"  fill="none"  stroke="#fff"  stroke-width="1.2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-gauge"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" /><path d="M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0" /><path d="M13.41 10.59l2.59 -2.59" /><path d="M7 12a5 5 0 0 1 5 -5" /></svg>
                                <div class="item-content">
                            ...
                            <div class="items">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="52"  height="52"  viewBox="0 0 24 24"  fill="none"  stroke="#fff"  stroke-width="1.2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-manual-gearbox"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 6m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M12 6m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M19 6m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M5 18m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M12 18m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" /><path d="M5 8l0 8" /><path d="M12 8l0 8" /><path d="M19 8v2a2 2 0 0 1 -2 2h-12" /></svg>
                                <div class="item-content">
                            ...
                            <div class="items">
                                <svg  xmlns="http://www.w3.org/2000/svg"  width="52"  height="52"  viewBox="0 0 24 24"  fill="none"  stroke="#fff"  stroke-width="1.2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-week"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 7a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-12z" /><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h16" /><path d="M7 14h.013" /><path d="M10.01 14h.005" /><path d="M13.01 14h.005" /><path d="M16.015 14h.005" /><path d="M13.015 17h.005" /><path d="M7.01 17h.005" /><path d="M10.01 17h.005" /></svg>
                                <div class="item-content">
                        ...
                        <!-- <div class="form-group">
                            <div class="group-select">
                                <div class="nice-select" tabindex="0">
                                    ...
                                    <ul class="list">
                                        <li data-value="0"><input type="text" placeholder="Search Make"></li>
                                        <li data-value="Audi" class="option">Audi</li>
                                        <li data-value="BMW" class="option">BMW</li>
                                        <li data-value="Dongfeng" class="option">Dongfeng</li>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="buy-sell-banner buy-banner wow fadeInUp animated">
                        <h3 class="title">Are You Looking For a <br>Used Car?</h3>
                        ...
                        <div class="hover-img">
                            <img src="images/buy-car.png">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="buy-sell-banner sell-banner wow fadeInUp animated">
                        <h3 class="title">Do You Want to Sell a <br>Car?</h3>
                        <div class="text">We are committed to providing our customers with exceptional service.</div>
                        <a href="" class="theme-btn">Get Started <i class="ti ti-arrow-up-right"></i></a>
                        <div class="hover-img">
                            <img src="images/sell-car.png">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="image-section">
                        ...
                        <div class="image-inner">
                            <img class="lazyloaded" data-src="images/why-us.jpg" src="images/why-us.jpg" alt="images">
                        </div>
                        <div class="image-inner2">
                            <img class="lazyloaded" data-src="images/why-choose-car.png" src="images/why-choose-car.png" alt="images">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="content-area">
                        <div class="heading-section">
                            ...
                            <p class="wow fadeInUpSmall" data-wow-delay="0.2s" data-wow-duration="1000ms">Our experienced team excels in car sales with many years of successfully
                                navigating the market, delivering informed decisions and optimal results.</p>
                        </div>
                        ...
                        <div class="tab-pane fade show active" id="nav-new" role="tabpanel" aria-labelledby="nav-new-tab">
                            <div class="row popular-car-slider" data-preview="4">
                                ...
                                <div class="car-block col-lg-3 col-md-6 col-sm-12">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <figure class="image"><a href="#"><img src="images/car-img4.jpg" alt=""></a></figure>
                                ...
                                <div class="car-block col-lg-3 col-md-6 col-sm-12">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <figure class="image"><a href="#"><img src="images/car-img2.jpg" alt=""></a></figure>
                                            <a href="#" class="icon-box">
                                                <i class="ti ti-heart"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="car-block col-lg-3 col-md-6 col-sm-12">
                                    <div class="inner-box">
                                        <div class="image-box two">
                                            <figure class="image"><a href="#"><img src="images/car-img3.jpg" alt=""></a></figure>
                                ...
                                <div class="car-block col-lg-3 col-md-6 col-sm-12">
                                    <div class="inner-box">
                                        <div class="image-box">
                                            <figure class="image"><a href="#"><img src="images/car-img1.jpg" alt=""></a></figure>
                                            <a href="#" class="icon-box">
                                                <i class="ti ti-heart"></i>
                                            </a>
                                        </div>
            ...
            <div class="row">
                ...
                <div class="cars-block col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="inner-box wow fadeInUp animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeInUp;">
                        <div class="image-box">
                            <img src="images/porsche-logo.png" alt="">
                        </div>
                        <div class="content-box">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="compare-item">
                                <div class="image-compare relative flex">
                                    <div class="image ">
                                        <img class="lazyload" data-src="images/compare1.jpg" src="images/compare1.jpg" alt="images">
                                    </div>
                                    <div class="image">
                                        <img class="lazyload" data-src="images/compare2.jpg" src="images/compare2.jpg" alt="images">
                                    </div>
                                    <div class="vs">VS</div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="compare-item">
                                <div class="image-compare relative flex">
                                    <div class="image ">
                                        <img class="lazyload" data-src="images/compare1.jpg" src="images/compare3.jpg" alt="images">
                                    </div>
                                    <div class="image">
                                        <img class="lazyload" data-src="images/compare2.jpg" src="images/compare4.jpg" alt="images">
                                    </div>
                                    <div class="vs">VS</div>
                                </div>
                                <div class="content-compare">
                        ...
                        <div class="col-lg-4 col-md-12 col-12">
                            <div class="compare-item">
                                <div class="image-compare relative flex">
                                    <div class="image ">
                                        <img class="lazyload" data-src="images/compare1.jpg" src="images/compare5.jpg" alt="images">
                                    </div>
                                    <div class="image">
                                        <img class="lazyload" data-src="images/compare2.jpg" src="images/compare6.jpg" alt="images">
                                    </div>
                                    <div class="vs">VS</div>
                                </div>
                                <div class="content-compare">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="blog-article-item">
                        <div class="article-images">
                            <img class="lazyload" data-src="images/blog-1.jpg" src="images/blog-1.jpg" alt="images">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="blog-article-item">
                        <div class="article-images">
                            <img class="lazyload" data-src="images/blog-1.jpg" src="images/blog-2.jpg" alt="images">
                            <div class="date">January 28, 2024</div>
                        </div>
                        <div class="content">
                            <div class="sub-box">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="blog-article-item">
                        <div class="article-images">
                            <img class="lazyload" data-src="images/blog-1.jpg" src="images/blog-3.jpg" alt="images">
                            <div class="date">January 28, 2024</div>
                        </div>
                        <div class="content">
                            <div class="sub-box">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="blog-article-item">
                        <div class="article-images">
                            <img class="lazyload" data-src="images/blog-1.jpg" src="images/blog-4.jpg" alt="images">
                            <div class="date">January 28, 2024</div>
                        </div>
                        <div class="content">
                            <div class="sub-box">
            ...
            <div class="container">
                <div class="right-box">
                    <div class="top-left wow fadeInUp animated">
                        ...
                        <div class="text">Excepteur sint occaecat cupidatat non proident, sunt in culpa <br>qui officia deserunt mollit anim id es</div>
            ...
            <div class="modal-body pd-40">
                <div class="wrap-modal d-flex">
                    <div class="images flex-none">
                        <img src="images/login-bg.png" alt="images">
                    </div>
                    <div class="login-content">
                        ...
                        <form method="post" class="comment-form form-submit" action="#" accept-charset="utf-8">
                            <fieldset class="">
                                ...
                                <input type="text" id="text1" name="text" placeholder="info@doamin.com">
                            </fieldset>
                            <fieldset class="">
                                <label>Enter Password</label>
                                <input type="password" id="text2" name="text" placeholder="123456">
                            </fieldset>
                            <button class="continuebtn mt-2" name="submit" type="button">Login</button>
                        </form>
                        <div class="text-box">Don’t you have an account? 
                    ...
                    <div class="login-content">
                        ...
                        <form method="post" class="comment-form form-submit" action="#" accept-charset="utf-8">
                            <fieldset class="">
                                ...
                                <input type="text" id="text3" name="text" placeholder="example: sanjesh sharma">
                            </fieldset>
                            <fieldset class="">
                                <label>Enter Your Email</label>
                                <input type="text" id="text4" name="text" placeholder="info@youname.com">
                            </fieldset>
                            <!-- <fieldset class="">
                            ...
                            <fieldset class="">
                                ...
                                <input type="text" id="text5" name="text" placeholder="+91 12345 67890">
                            </fieldset>
                    ...
                    <div class="otp-verification">
                        ...
                        <form method="post" class="verification" action="#">
                            <fieldset class="">
                                ...
                                <input type="text" id="text6" name="text" placeholder="Enter OTP">
...
<!-- Scroll To Top -->
<div class="scroll-to-top scroll-to-target" data-target="html" title="Go To Top"><img src="images/car-up.png" class="car-scroll-img"></div>
