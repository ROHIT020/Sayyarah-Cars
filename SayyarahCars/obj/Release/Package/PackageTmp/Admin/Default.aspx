<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/Main.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SayyarahCars.Admin.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="p-4">
                                ...
                                <p class="text-white">The Brand new User Interface with power of Bootstrap Components. Explore the Endless possibilities with Bizupon.</p>
                            </div>
                        </div>
                        <div class="col-sm-6 text-center">
                            <div class="img-welcome-banner">
                                <img src="../Contents/images/range-rover.png" alt="img" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="card-block">
                        <div class="card-thumb">
                            <img src="../images/car.png" class="w-75">
                        </div>
                        <div class="content">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-block">
                        <div class="card-thumb">
                            <img src="../Contents/images/car.png" class="w-75">
                        </div>
                        <div class="content">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-block">
                        <div class="card-thumb">
                            <img src="../Contents/images/pending.png" class="w-50">
                        </div>
                        <div class="content">
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-block">
                        <div class="card-thumb">
                            <img src="../Contents/images/seller.png" class="w-50">
                        </div>
                        <div class="content">
    ...
    <script src="../Contents/js/apexcharts.min.js"></script>
    <script src="../Contents/js/stock-prices.js"></script>
    <script src="../Contents/js/stock-prices.js"></script>
